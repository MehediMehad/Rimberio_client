...
const MyRecommendations = () => {
    ...
    const getData = async () =>{
        const {data} = await axios(`https://assignment-eleven-server-chi-two.vercel.app/recommend/${user.email}` , {withCredentials: true})
        setRecomend(data)
    }

    const handleDelete = async _id =>{
        try{
            const {data} = await axios.delete(`https://assignment-eleven-server-chi-two.vercel.app/deleteRecommend/${_id}`)
            console.log(data);
