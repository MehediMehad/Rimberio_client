...
const MyRecommendations = () => {
    ...
    const filt = recommendData.filter(p => p.recommendedUser.email === user.email )
    console.log(recommendData, 'pppppppppppppp');
                        ...
                        <div className='overflow-hidden border border-gray-200  md:rounded-lg'>
                            <table className='min-w-full divide-y divide-gray-200'>
                                ...
                                <tbody className='bg-white divide-y divide-gray-200 '>
                                    {
                                        filt.map(recomat => <tr key={recomat._id}>
                                            <td className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                                                {recomat.title}
                                            </td>

                                            <td className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                                                {new Date (recomat.recommendedUser.currentDate).toDateString()}
                                            </td>
