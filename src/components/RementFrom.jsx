            ...
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div className="inline-flex items-center gap-x-3">
                    ...
                    <div className="flex items-center gap-x-2">
                        ...
                        <div>
                            <h2 className="font-medium text-gray-800 dark:text-white ">{recommendedUser.recomedUser}</h2>
                            <p className="text-sm font-normal text-gray-600 dark:text-gray-400">{recommendedUser.email}</p>
                        </div>
                    </div>
                </div>
            </td>
...
RementFrom.propTypes  ={
    recomat: PropTypes.object
}
export default RementFrom;