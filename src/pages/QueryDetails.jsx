...
const QueryDetails = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            const { data } = await axios(`https://assignment-eleven-server-chi-two.vercel.app/myProduces/${addedUser.email}`)
    ...
    const handlerecommendation = async e =>{
        ...
        try{
            const {data} = await axios.post('https://assignment-eleven-server-chi-two.vercel.app/recommend', recommendationInfo)
            console.log(data)
