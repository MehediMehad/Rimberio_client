...
const Queries = () => {
  ...
  return (
    <>
      <form className="from-current mt-10 mx-40">
      ...
      <div className="grid grid-cols-4 my-10 gap-5 mx-40">
        ...
        {
          queries.filter((product) => product.name.toLowerCase().includes(need)).map(p => <div key={p._id} className="card col-span-1 card-compact bg-base-100 shadow-xl p-x-5 ">
